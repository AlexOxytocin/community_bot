...
**Статус:** Заменено ADR-0009 в части hosting, release, логов и backup/restore
...
**Заменено владельцем:** 2026-08-11. Пилот переносится с Render на собственный
сервер; продуктовая граница пилота и исключение external backup, application
object storage и webhook сохраняются.
