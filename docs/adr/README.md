...
- Независимая проверка ADR нужна только при реальном архитектурном или release-риске.
- Решение принимает владелец; для обычной tracked-задачи отдельный review не обязателен.
...
- [ADR-0020 — Быстрый automatic delivery одного dev server](0020-fast-dev-delivery.md)
- [ADR-0021 — Jira-lite для текущей разработки](0021-jira-lite-development.md)
