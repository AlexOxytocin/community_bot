...
Миграция `0002` создаёт `members`, `audit_events` и `processed_telegram_updates`, ограничения ролей и статусов, а также PostgreSQL trigger, запрещающий изменение и удаление audit events.
