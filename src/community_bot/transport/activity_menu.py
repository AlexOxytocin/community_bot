...
CATEGORY_COPY = {
    ...
    "digest": (
        ...
        "Агрегированный и сгруппированный по темам обзор обсуждений чата с тегом #digest.",
    ),
...
def activity_panel(
    ...
    if page == "help":
        text = (
            ...
            "🗞 Еженедельный дайджест\n"
            "Раз в неделю собираем главное из обсуждений чата и группируем по темам, "
            "чтобы важное можно было быстро прочитать в одном сообщении.\n\n"
            "💬 Живое общение\n"
