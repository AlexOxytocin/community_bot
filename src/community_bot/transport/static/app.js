...
const communityAchievementCatalog = [
  {
    ...
    icon: "💬",
    title: "Спикер",
    hint: "Пишите сообщения в чате. Уровни: 10, 30, 60, 120, 250, 450, 750, 1 200, 2 000 и 3 000 сообщений.",
  },
  {
    code: "magnet",
    icon: "🎯",
    title: "Магнит",
    hint: "Получайте реакции на свои сообщения. Уровни: 5, 15, 30, 60, 120, 200, 350, 600, 1 000 и 1 500 реакций.",
  },
  {
    code: "petrosyan",
    icon: "🤣",
    title: "Петросян",
    hint: "Получайте реакции 😁 и 🤣 на свои сообщения. Уровни: 5, 15, 30, 60, 120, 200, 350, 600, 1 000 и 1 500 реакций.",
  },
  {
    code: "sharp",
    icon: "💯",
    title: "Чёткий",
    hint: "Получайте реакцию 💯 на свои сообщения. Уровни: 5, 15, 30, 60, 120, 200, 350, 600, 1 000 и 1 500 реакций.",
  },
  {
    code: "firefighter",
    icon: "🔥",
  ...
  },
  {
    ...
    icon: "❤️‍🔥",
    title: "Сердцеед",
    hint: "Получайте ❤️, ❤️‍🔥, ❤️‍🩹 или цветные сердца на свои сообщения. Уровни: 5, 15, 30, 60, 120, 200, 350, 600, 1 000 и 1 500 реакций.",
  },
  {
    code: "support",
    icon: "🙌",
    title: "Поддержка",
    hint: "Ставьте реакции на сообщения в чате. Уровни: 10, 30, 60, 120, 250, 450, 750, 1 200, 2 000 и 3 000 реакций.",
  },
  {
    code: "regular",
    icon: "📅",
    title: "Завсегдатай",
    hint: "Будьте активны в разные дни. Уровни: 3, 7, 14, 30, 60, 100, 150, 220, 300 и 365 дней.",
  },
  {
    code: "explorer",
    icon: "🧭",
    title: "Исследователь",
    hint: "Участвуйте в разных темах. Уровни: 2, 3, 5, 7, 10, 14, 18, 25, 35 и 50 тем.",
  },
  {
    code: "streak",
    icon: "🔥",
    title: "Серия",
    hint: "Будьте активны без перерыва. Уровни: 3, 5, 7, 10, 14, 21, 30, 45, 60 и 100 дней подряд.",
  },
  {
    code: "dialog",
    icon: "↩️",
    title: "Диалог",
    hint: "Отправляйте сообщения-ответы. Уровни: 10, 30, 60, 120, 250, 450, 750, 1 200, 2 000 и 3 000 ответов.",
  },
  {
    code: "wealth",
    icon: "💰",
    title: "Я богач",
    hint: "Достигайте нового максимального баланса. Уровни: 20, 40, 70, 100, 150, 220, 300, 400, 550 и 750 кредитов.",
  },
  {
    code: "manager",
    icon: "🗂️",
    title: "Менеджер",
    hint: "Создавайте задания для сообщества. Уровни: 1, 3, 5, 10, 15, 25, 40, 60, 80 и 120 заданий.",
  },
];
