...
const communityAchievementCatalog = [
  {
    ...
    icon: "💬",
    title: "Спикер",
    hint: "Пишите сообщения в чате. Уровни открываются после 10, 50, 200 и 1 000 сообщений.",
  },
  {
    code: "magnet",
    icon: "🎯",
    title: "Магнит",
    hint: "Получайте реакции на свои сообщения. Уровни открываются после 10, 50, 200 и 1 000 реакций.",
  },
  {
    code: "support",
    icon: "🙌",
    title: "Поддержка",
    hint: "Ставьте реакции на сообщения в чате. Уровни открываются после 10, 50, 200 и 1 000 реакций.",
  },
  {
    code: "regular",
    icon: "📅",
    title: "Завсегдатай",
    hint: "Будьте активны в разные дни: пишите сообщения, ставьте или получайте реакции. Уровни: 3, 10, 30 и 100 активных дней.",
  },
  {
    code: "explorer",
    icon: "🧭",
    title: "Исследователь",
    hint: "Участвуйте в разных темах: пишите сообщения, ставьте или получайте реакции. Уровни: 2, 5, 10 и 25 тем.",
  },
  {
    code: "streak",
    icon: "🔥",
    title: "Серия",
    hint: "Будьте активны каждый день без перерыва: пишите сообщения, ставьте или получайте реакции. Уровни: 3, 7, 14 и 30 дней подряд.",
  },
];
