...
- Один forced-command Python entrypoint применяет cached native build, проверяет target/live Alembic head, public `/readyz` и rollback.
...
- `ruff format`, `ruff check`, `ty`, targeted unit/policy tests: green.
